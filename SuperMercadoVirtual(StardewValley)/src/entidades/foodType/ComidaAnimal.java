...
public class ComidaAnimal extends Comida {

    public ComidaAnimal(String nome, Double preco, String indentificacao, int quantidade, String tipo,int saude,int energia ) {
